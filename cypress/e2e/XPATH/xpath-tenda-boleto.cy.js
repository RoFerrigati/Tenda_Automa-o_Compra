import seletores from '../../SELETORES/xpath-seletores.cy';
...
describe('Teste Tenda Atacado - Compra com Boleto', () => {
    ...
    it('Deve adicionar o produto ao carrinho e navegar até o carrinho', () => {
        ...
        // Produto Tenda: Add Seleta ao carrinho:
        ...
        listaBoleto.forEach(seletor => {
            ...
            if (seletor === seletores.pagamentoBoleto.confirmaBoleto) {
                cy.xpath("//span[@id='btFechar']", { timeout: 10000 })
                    // .should('be.visible')
                    // .should('not.be.disabled')
                    .click();
                cy.xpath(seletores.pagamentoBoleto.codigoBoleto)
                    .should('be.visible');
            };
        });
    });
